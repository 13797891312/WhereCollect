...
public class VolleyErrorHelper {
            ...
            switch (response.statusCode) {
                ...
                case 401:
                    try {
                        ...
                        LogUtil.e(response.statusCode + "---" + new String(response.data));
                    ...
                    // invalid request
                    if (StringUtils.isNullOrBlanK(error.getMessage())) {
                        return "连接服务器失败~！";
                    }
    ...
    public static void checkNetWork(final Context context) {
        try {
            ...
            Builder b = new Builder(context).setCancelable(false).setTitle(
